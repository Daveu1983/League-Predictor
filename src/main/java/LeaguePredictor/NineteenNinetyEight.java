...
public class NineteenNinetyEight extends NineteenNinetyThree {
    ...
    public ArrayList<String> createTable() {
        ArrayList<String> nineteen98 = new ArrayList<>();
        {
    ...
    public String[] createPromoted() {
        return new String[]{LeaguePredictor.NOTTINGHAM_FOREST, LeaguePredictor.MIDDLESBOROUGH, LeaguePredictor.CHARLTON_ATHLETIC};
    }
}
