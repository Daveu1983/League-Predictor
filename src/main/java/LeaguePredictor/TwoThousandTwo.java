...
public class TwoThousandTwo extends NineteenNinetyThree {
    public ArrayList<String> createTable() {
        ArrayList<String> twoThousand02 = new ArrayList<>();
        {
    ...
    public String[] createPromoted () {
        return new String[]{LeaguePredictor.MANCHESTER_CITY, LeaguePredictor.WEST_BROMWICH_ALBION, LeaguePredictor.BIRMINGHAM_CITY};
    }
}
