...
public class NineteenNinetyFour extends NineteenNinetyThree {
	public ArrayList<String> createTable() {
		...
		ArrayList<String> nineteen94 = new ArrayList<>(); {
	...
	public String [] createPromoted(){
		return new String[]{LeaguePredictor.CRYSTAL_PALACE, LeaguePredictor.NOTTINGHAM_FOREST, LeaguePredictor.NORWICH_CITY};
	}
