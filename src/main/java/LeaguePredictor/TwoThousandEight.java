...
public class TwoThousandEight extends NineteenNinetyThree {

    public ArrayList<String> createTable() {
        ArrayList<String> twoThousand08 = new ArrayList<>();
        {
    ...
    public String[] createPromoted() {
        return new String[]{LeaguePredictor.WEST_BROMWICH_ALBION, LeaguePredictor.STOKE_CITY, LeaguePredictor.HULL_CITY};
    }
}
