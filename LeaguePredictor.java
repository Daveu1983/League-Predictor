...
public class LeaguePredictor {
   ...
   // yearOne.printTable(yearOneTable);
    ...
    "Arsenal", "Livepool",
    "Aston Villa", "Chelsea", "Sheffield Wednesday", 
    "Wimbledon", "Leicester City",
    "Tottenham Hotspur", "Leeds United", "Derby County", "Blackburn Rovers", 
    "West Ham United", "Everton", "Southampton", "Coventry City", "Sunderland", 
    "Middlesborough", "Nottingham Forest"};
