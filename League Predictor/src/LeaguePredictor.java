...
public class LeaguePredictor {
    ...
    public static final String NORWICH_CITY = "Norwich City";
    public static final String BLACKBURN_ROVERS = "Blackburn Rovers";
    public static final String QPR = "QPR";
    public static final String SHEFFIELD_WEDNESDAY = "Sheffield Wednesday";
    ...
    public static final String BLACKPOOL = "Blackpool";
    public static final String EVERTON = "Everton";
    public static final String WIMBLEDON = "Wimbledon";
    public static final String SHEFFIELD_UNITED = "Sheffield United";
    public static final String COVENTRY_CITY = "Coventry City";
    public static final String IPSWICH_TOWN = "Ipswich Town";
    public static final String LEEDS_UNITED = "Leeds United";
    public static final String SOUTHAMPTON = "Southampton";
    public static final String OLDHAM_ATHLETIC = "Oldham Athletic";
    public static final String CRYSTAL_PALACE = "Crystal Palace";
    public static final String MIDDLESBOROUGH = "Middlesborough";
    public static final String BRADFORD_CITY = "Bradford City";
    public static final String WATFORD = "Watford";
    public static final String NOTTINGHAM_FOREST = "Nottingham Forest";
    public static final String NEWCASTLE = "Newcastle";
    public static final String WEST_HAM_UNITED = "West Ham United";
    public static final String SWINDON_TOWN = "Swindon Town";
    public static final String SWANSEA_CITY = "Swansea City";
    public static final String LEICESTER_CITY = "Leicester City";
    public static final String BOLTON_WANDERERS = "Bolton Wanderers";
    public static final String BRIGHTON_HOVE_ALBION = "Brighton & Hove Albion";
    ...
    public static final String DERBY_COUNTY = "Derby County";
    public static final String AFC_BOURNEMOUTH = "AFC Bournemouth";
    public static final String SUNDERLAND = "Sunderland";
    public static final String BARNSLEY = "Barnsley";
    public static final String WIGAN_ATHLETIC = "WIGAN_ATHLETIC";
    public static final String CHARLTON_ATHLETIC = "Charlton Athletic";
    public static final String READING = "Reading";
    public static final String BIRMINGHAM_CITY = "Birmingham City";
    public static final String WEST_BROMWICH_ALBION = "West Bromwich Albion";
    public static final String STOKE_CITY = "Stoke City";
    public static final String HULL_CITY = "Hull City";
    public static final String PORTSMOUTH = "Portsmouth";
    public static final String WOLVERHAMPTON_WANDERERS = "Wolverhampton Wanderers";
    ...
    public static void main(String[] args) {
        ...
        for (Map.Entry<Integer, Integer> entry : whereThirteenWillFini) {
          ...
          for (int d = 0; d < yearTwentySixTable.size(); d++) {
            ...
            theLeague.put(yearTwentySixTable.get(d), leaguePredicted.get(d));
