...
public class NineteenNinetySix extends NineteenNinetyThree {
	public ArrayList<String> createTable() {
		ArrayList<String> nineteen96 = new ArrayList<String>(); {
			nineteen96.add("Manchester United");
			nineteen96.add("Newcastle United");
			nineteen96.add("Liverpool");
			nineteen96.add("Aston Villa");
			nineteen96.add("Arsenal");
			nineteen96.add("Everton");
			nineteen96.add("Blackburn Rovers");
			nineteen96.add("Tottenham Hotspur");
			nineteen96.add("Nottingham Forest");
			nineteen96.add("West Ham United");
			nineteen96.add("Chelsea");
